<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/www/wwwroot/peigongtang/public/../application/admin/view/Webcast/add.html";i:1609145243;s:65:"/www/wwwroot/peigongtang/application/admin/view/Public/base2.html";i:1608535069;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="clientType" value="0" title="标准版" <?php if(isset($detail['clientType'])): if(0
                               == $detail['clientType']): ?>checked<?php endif; endif; ?> checked>
                        <input type="radio" name="clientType" value="1" title="轻量版" <?php if(isset($detail['clientType'])): if(1
                               == $detail['clientType']): ?>checked<?php endif; endif; ?>>
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label"><span style="color:red">*</span>组织者加入直播密码</label>
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="text" name="organizerToken" maxlength="15" required
                               value="<?php echo !empty($detail['organizerToken'])?$detail['organizerToken']:''; ?>"
                               placeholder="请输入密码" class="layui-input">
                    </div>
                </div>

                <div class="layui-form-item">
                    <label class="layui-form-label"><span style="color:red">*</span>嘉宾直播密码</label>
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="text" name="panelistToken" maxlength="15" required
                               value="<?php echo !empty($detail['panelistToken'])?$detail['panelistToken']:''; ?>"
                               placeholder="请输入密码" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">普通参与者直播密码</label>
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="text" name="attendeeToken" maxlength="15"
                               value="<?php echo !empty($detail['attendeeToken'])?$detail['attendeeToken']:''; ?>"
                               placeholder="请输入密码" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label"><span style="color:red">*</span>直播开启时间</label>
                    <div class="layui-input-inline">
                        <input type="text" id="test5" name="startTime" placeholder="yyyy-MM-dd HH:mm:ss" required
                               class="layui-input" <?php if(!(empty($detail) || (($detail instanceof \think\Collection || $detail instanceof \think\Paginator ) && $detail->isEmpty()))): ?> value="<?php echo $detail['startTime']; ?>" <?php endif; ?>>
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label">直播关闭时间</label>
                    <div class="layui-input-inline">
                        <input type="text" id="test6" name="endTime" placeholder="yyyy-MM-dd HH:mm:ss"
                               class="layui-input" <?php if(!(empty($detail) || (($detail instanceof \think\Collection || $detail instanceof \think\Paginator ) && $detail->isEmpty()))): ?> value="<?php echo $detail['endTime']; ?>" <?php endif; ?>>
                    </div>*	只有当站点具有定时关闭功能该设置的值才生效
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="opened" value="true" title="是" <?php if(isset($detail['opened'])): if(true
                               == $detail['opened']): ?>checked<?php endif; endif; ?>>
                        <input type="radio" name="opened" value="false" title="否" <?php if(isset($detail['opened'])): if(false
                               == $detail['opened']): ?>checked<?php endif; endif; ?> checked>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">演讲者信息</label>
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">直播议程安排</label>
                    <div class="layui-input-inline" style="width: 600px;">
                        <textarea class="layui-textarea" name="plan" maxlength="250"
                                  placeholder="直播议程安排"
                                  class="layui-input"><?php echo !empty($detail['plan'])?$detail['plan']:''; ?></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">直播描述信息</label>
                    <div class="layui-input-inline" style="width: 600px;">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">是否允许升级到客户端</label>
                    <div class="layui-input-block">
                        <input type="radio" name="switchClient" value="true" title="是" <?php if(isset($detail['switchClient'])): if(true
                               == $detail['switchClient']): ?>checked<?php endif; endif; ?> checked>
                        <input type="radio" name="webJoin" value="false" title="否" <?php if(isset($detail['switchClient'])): if(false
                               == $detail['switchClient']): ?>checked<?php endif; endif; ?>>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">是否开启实时功能</label>
                    <div class="layui-input-block">
                        <input type="radio" name="realtime" value="true" title="是" <?php if(isset($detail['realtime'])): if(true
                               == $detail['realtime']): ?>checked<?php endif; endif; ?> checked>
                        <input type="radio" name="realtime" value="false" title="否" <?php if(isset($detail['realtime'])): if(false
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="skin" value="default" title="默认" <?php if(isset($detail['skin'])): if("default"
                        == $detail['skin']): ?>checked<?php endif; endif; ?> checked>
                        <input type="radio" name="skin" value="blue" title="蓝色" <?php if(isset($detail['skin'])): if("blue"
                        == $detail['skin']): ?>checked<?php endif; endif; ?>>
                        <input type="radio" name="skin" value="green" title="绿色" <?php if(isset($detail['skin'])): if("green"
                        == $detail['skin']): ?>checked<?php endif; endif; ?>>
                        <input type="radio" name="skin" value="gray" title="灰色" <?php if(isset($detail['skin'])): if("gray"
                        == $detail['skin']): ?>checked<?php endif; endif; ?>>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">aac</label>
                    <div class="layui-input-block">
                        <input type="radio" name="aac" value="true" title="是" <?php if(isset($detail['aac'])): if(true
                               == $detail['aac']): ?>checked<?php endif; endif; ?>>
                        <input type="radio" name="aac" value="false" title="否" <?php if(isset($detail['aac'])): if(false
                               == $detail['aac']): ?>checked<?php endif; endif; ?> checked>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">是否开启外呼</label>
                    <div class="layui-input-block">
                        <input type="radio" name="telconf" value="0" title="不开启" <?php if(isset($detail['telconf'])): if(0
                               == $detail['telconf']): ?>checked<?php endif; endif; ?> checked>
                        <input type="radio" name="telconf" value="1" title="仅开启外呼邀请" <?php if(isset($detail['telconf'])): if(1
                               == $detail['telconf']): ?>checked<?php endif; endif; ?>>
                        <input type="radio" name="telconf" value="2" title="开启外呼邀请，同时接受电话呼入" <?php if(isset($detail['telconf'])): if(2
                               == $detail['telconf']): ?>checked<?php endif; endif; ?>>
                    </div>
                </div>
                <div class="layui-form-item">
