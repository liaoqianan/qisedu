<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"D:\pgt\public/../application/admin\view\course_node\add.html";i:1608170297;s:47:"D:\pgt\application\admin\view\Public\base2.html";i:1599547052;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="text" name="title" maxlength="20" required value="<?php echo !empty($detail['title'])?$detail['title']:''; ?>" lay-verify="required" placeholder="请输入课节名称" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline"  style="width: 500px; ">
                        <select name="course_id">
                            ...
                            <option <?php if(!(empty($detail) || (($detail instanceof \think\Collection || $detail instanceof \think\Paginator ) && $detail->isEmpty()))): if($detail['course_id']==$vo['id']): ?> selected <?php endif; endif; ?> value="<?php echo $vo['id']; ?>"><?php echo $vo['title']; ?></option>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="type" value="1" title="直播" <?php if(isset($detail['type'])): if(1 == $detail['type']): ?>checked<?php endif; endif; ?> checked>
                        <input type="radio" name="type" value="2" title="回放" <?php if(isset($detail['type'])): if(2 == $detail['type']): ?>checked<?php endif; endif; ?>>
                        <input type="radio" name="type" value="3" title="视频" <?php if(isset($detail['type'])): if(3 == $detail['type']): ?>checked<?php endif; endif; ?>>
                        <input type="radio" name="type" value="4" title="音频" <?php if(isset($detail['type'])): if(4 == $detail['type']): ?>checked<?php endif; endif; ?>>
                        <input type="radio" name="type" value="5" title="图文" <?php if(isset($detail['type'])): if(5 == $detail['type']): ?>checked<?php endif; endif; ?>>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">是否收费</label>
                    <div class="layui-input-block">
                        <input type="radio" name="is_gratis" value="1" title="收费" <?php if(isset($detail['is_gratis'])): if(1 == $detail['is_gratis']): ?>checked<?php endif; endif; ?> checked>
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="test5" name="broadcast_time" placeholder="yyyy-MM-dd HH:mm:ss（点播不填）" class="layui-input" <?php if(!(empty($detail) || (($detail instanceof \think\Collection || $detail instanceof \think\Paginator ) && $detail->isEmpty()))): ?> value="<?php echo $detail['broadcast_time']; ?>" <?php endif; ?>>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"><span style="color:red">*</span> 原价</label>
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="number" name="original_price" maxlength="20" required value="<?php echo !empty($detail['original_price'])?$detail['original_price']:''; ?>" lay-verify="required" placeholder="请输入原价（免费填0）" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"><span style="color:red">*</span> 现价</label>
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="number" name="present_price" maxlength="20" required value="<?php echo !empty($detail['present_price'])?$detail['present_price']:''; ?>" lay-verify="required" placeholder="请输入现价（免费填0）" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">可观看时长</label>
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="number" name="watch_time" maxlength="20" required value="<?php echo !empty($detail['watch_time'])?$detail['watch_time']:''; ?>" lay-verify="required" placeholder="请输入观看时长（秒）" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">参数</label>
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="text" name="parameter" maxlength="20" required value="<?php echo !empty($detail['parameter'])?$detail['parameter']:''; ?>" lay-verify="required" placeholder="请输入参数" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 600px;">
                        <textarea class="layui-textarea" name="brief" maxlength="100" required lay-verify="required" placeholder="课节简介" class="layui-input"><?php echo !empty($detail['brief'])?$detail['brief']:''; ?></textarea>
                    </div>
                </div>
