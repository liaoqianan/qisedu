<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\pgt\public/../application/admin\view\Album\AlbumCategory.html";i:1599547055;s:46:"D:\pgt\application\admin\view\Public\base.html";i:1599547052;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-field-box">
            <form class="layui-form" id="form-admin-add" action="">
                <div class="layui-inline">
                    <span class="layui-btn layui-btn-normal api-add" data-title="新增专辑分类"><i class="layui-icon">&#xe608;</i> 新增</span>
                </div>
            </form>
