<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/www/wwwroot/peigongtang/public/../application/admin/view/Activity/index.html";i:1611716151;s:64:"/www/wwwroot/peigongtang/application/admin/view/Public/base.html";i:1610075700;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form class="layui-form" id="form-admin-add" action="">
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <input type="text" name="title" value="" placeholder="请填写活动名称" maxlength="20" class="layui-input" onkeyup='clearSymbol(this)'>
                    </div>
                </div>
                <div class="layui-inline">
                ...
                <div class="layui-inline" style="float: right;">
                    <span class="layui-btn layui-btn-normal api-add" data-title="新增活动"><i class="layui-icon">&#xe608;</i> 新增</span>
                </div>
            </form>
                ...
                columnDefs:[
                    {
                        ...
                        "render":function(data, type, row) {
                            return '<span class="layui-btn layui-btn-small edit layui-btn-normal" data-id="' + row.id +'" data-title="详情" data-url="<?php echo url('details'); ?>"><i>详情</i></span>';
                        }
                    },
                    {
                        "targets":-1,
