<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/www/wwwroot/peigongtang/public/../application/admin/view/Calendar/add.html";i:1608535059;s:65:"/www/wwwroot/peigongtang/application/admin/view/Public/base2.html";i:1608535069;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="text" name="name" maxlength="100" required value="<?php echo !empty($detail['name'])?$detail['name']:''; ?>" lay-verify="required" placeholder="请输入姓名" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="text" name="G_calendar" maxlength="100" <?php if(isset($detail['type'])): if(1 == $detail['type']): ?>  value="<?php echo !empty($detail['G_calendar'])?$detail['G_calendar']:''; ?>" <?php endif; endif; ?> placeholder="请输入公历出生年月日时（如2020-12-07 12:00）" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">农历</label>
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="text" name="L_calendar" maxlength="100" <?php if(isset($detail['type'])): if(2 == $detail['type']): ?>  value="<?php echo !empty($detail['L_calendar'])?$detail['L_calendar']:''; ?>" <?php endif; endif; ?> placeholder="请输入农历出生年月日时（如2020-12-07 12:00）" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">生辰八字</label>
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="text" name="S_calendar" maxlength="100" <?php if(isset($detail['type'])): if(3 == $detail['type']): ?> value="<?php echo !empty($detail['S_calendar'])?$detail['S_calendar']:''; ?>" <?php endif; endif; ?> placeholder="请输入生辰八字（如：庚子戊子甲申庚午）" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">性别</label>
                    <div class="layui-input-block">
                        <input type="radio" name="sex" value="1" title="男" <?php if(isset($detail['sex'])): if(1 == $detail['sex']): ?>checked<?php endif; endif; ?> checked>
                        <input type="radio" name="sex" value="2" title="女" <?php if(isset($detail['sex'])): if(2 == $detail['sex']): ?>checked<?php endif; endif; ?>>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
...
<block name="myScript">
    <script type="text/javascript" src="/static/admin/js/citys.js"></script>
    <script>
        <?php if(isset($detail)): ?>
        pca.init('select[name=province]', 'select[name=city]', 'select[name=area]', '<?php echo $detail['province']; ?>', '<?php echo $detail['city']; ?>', '<?php echo $detail['area']; ?>');
        <?php else: ?>
            pca.init('select[name=province]', 'select[name=city]', 'select[name=area]', '北京市', '北京市', '朝阳区');
            <?php endif; ?>
        function tips(msg) {
            layer.msg(msg, {
                icon: 5,
