<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\pgt\public/../application/admin\view\Music\MusicCategory.html";i:1599547055;s:46:"D:\pgt\application\admin\view\Public\base.html";i:1599547052;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-field-box">
            <form class="layui-form" id="form-admin-add" action="">
                <div class="layui-inline">
                    <span class="layui-btn layui-btn-normal api-add" data-title="新增音乐分类"><i class="layui-icon">&#xe608;</i> 新增</span>
                </div>
            </form>
    ...
    <script>
        layui.use(['form', 'layer'], function() {
            ...
            $('.api-add').on('click', function () {
                ...
                layer.open({
                    ...
                    area: ['60%', '50%'],
                    maxmin: true,
                    content: '<?php echo url("addCategory"); ?>'
                });
            });
        ...
        var myFun = function (query) {
            ...
            return $('#list-admin').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url:'<?php echo url("ajaxGetCategory"); ?>' + query,
                    type: 'POST',
                ...
                columnDefs:[
                    {
                        ...
                        "render":function(data, type, row) {
                            var returnStr = '';
                            returnStr += '<span class="layui-btn layui-btn-small edit layui-btn-normal" data-id="' + row.id +'" data-title="编辑" data-url="<?php echo url('editCategory'); ?>"><i class="layui-icon">&#xe642;</i></span>';
                            returnStr += '<span class="layui-btn layui-btn-small confirm layui-btn-danger"  data-id="' + row.id +'" data-title="删除" data-info="你确定要删除吗" data-url="<?php echo url('delCategory'); ?>" confirm><i class="layui-icon">&#xe640;</i></span>';
                            return returnStr;
                        }
                    }
                ],
