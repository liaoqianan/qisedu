<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"D:\pgt\public/../application/admin\view\Album\index.html";i:1599547055;s:46:"D:\pgt\application\admin\view\Public\base.html";i:1599547052;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form class="layui-form" id="form-admin-add" action="">
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <input type="text" name="title" value="" placeholder="请填写专辑名称" maxlength="12" class="layui-input" onkeyup='clearSymbol(this)'>
                    </div>
                </div>
                <div class="layui-input-inline">
                    <select name="category_id">
                        <option value=" ">专辑分类</option>
