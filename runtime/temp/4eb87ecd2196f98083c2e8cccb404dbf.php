<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/www/wwwroot/peigongtang/public/../application/admin/view/Payment/add.html";i:1611282122;s:65:"/www/wwwroot/peigongtang/application/admin/view/Public/base2.html";i:1608535069;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form class="layui-form" action="">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="text" name="mobile" maxlength="20" required
                               value="<?php echo !empty($detail['mobile'])?$detail['mobile']:''; ?>" lay-verify="required" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px; ">
                        <select name="column_id">
                            ...
                            'column_id']==$vo['id']): ?> selected <?php endif; endif; ?> value="<?php echo $vo['id']; ?>"><?php echo $vo['title']; ?></option>
