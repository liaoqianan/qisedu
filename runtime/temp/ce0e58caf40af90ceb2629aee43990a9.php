<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/www/wwwroot/peigongtang/public/../application/admin/view/Article/index.html";i:1610075688;s:64:"/www/wwwroot/peigongtang/application/admin/view/Public/base.html";i:1610075700;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form class="layui-form" id="form-admin-add" action="">
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <input type="text" name="nickname" value="" placeholder="请填写文章标题" maxlength="12" class="layui-input" onkeyup='clearSymbol(this)'>
                    </div>
                </div>
                <div class="layui-inline">
                ...
                <div class="layui-inline" style="float: right;">
                    <span class="layui-btn layui-btn-normal api-add" data-title="新增文章"><i class="layui-icon">&#xe608;</i> 新增</span>
                </div>
            </form>
