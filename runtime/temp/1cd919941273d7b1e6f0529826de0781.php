<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"/www/wwwroot/peigongtang/public/../application/admin/view/Column/add.html";i:1608535060;s:65:"/www/wwwroot/peigongtang/application/admin/view/Public/base2.html";i:1608535069;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<block name="main">
    <fieldset class="layui-elem-field">
        <legend>栏目管理 - <?php echo !empty($detail['id'])?'编辑':'新增'; ?></legend>
            ...
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="text" name="title" maxlength="100" required value="<?php echo !empty($detail['title'])?$detail['title']:''; ?>" lay-verify="required" placeholder="请输入栏目标题" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"><span style="color:red">*</span> 栏目简介</label>
                    <div class="layui-input-inline" style="width: 600px;">
                        <textarea class="layui-textarea" name="brief" maxlength="100" required lay-verify="required" placeholder="栏目简介" class="layui-input"><?php echo !empty($detail['brief'])?$detail['brief']:''; ?></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
