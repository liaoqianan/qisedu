<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/www/wwwroot/peigongtang/public/../application/admin/view/Webcast/index.html";i:1609145626;s:64:"/www/wwwroot/peigongtang/application/admin/view/Public/base.html";i:1610075700;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        var myFun = function (query) {
            ...
            return $('#list-admin').DataTable({
                ...
                columns: [
                    ...
                    {"data": "panelistToken" },
                    {"data": "attendeeToken" },
                    {"data": "organizerJoinUrl" },
                    {"data": "panelistJoinUrl" },
                    {"data": "attendeeJoinUrl" },
                    {"data": "clientType" },
                    {"data": null }
                ],
            });
