<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/www/wwwroot/peigongtang/public/../application/admin/view/Wechat/index.html";i:1611041698;s:64:"/www/wwwroot/peigongtang/application/admin/view/Public/base.html";i:1610075700;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        layui.use(['form', 'layer'], function() {
            ...
            $('#setmenu').click(function(event) {
                top.layer.confirm('确定重新生成公众号菜单吗？',{icon:3, title:'提示信息'},function(indexs){
                    $.get("<?php echo url('Wechat/setMenu'); ?>",function(data){
