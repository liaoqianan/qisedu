<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"D:\pgt\public/../application/admin\view\course\add.html";i:1607997767;s:47:"D:\pgt\application\admin\view\Public\base2.html";i:1599547052;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="radio" name="type" value="2" title="点播" <?php if(isset($detail['type'])): if(1 == $detail['type']): ?>checked<?php endif; endif; ?>>
                    </div>
                </div>
