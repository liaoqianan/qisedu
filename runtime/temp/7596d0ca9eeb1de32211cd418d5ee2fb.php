<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"D:\pgt\public/../application/admin\view\activity\add.html";i:1608183415;s:47:"D:\pgt\application\admin\view\Public\base2.html";i:1599547052;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="number" name="enroll_num"  maxlength="20" required
                               <?php if(!(empty($detail) || (($detail instanceof \think\Collection || $detail instanceof \think\Paginator ) && $detail->isEmpty()))): ?>  value="<?php echo $detail['enroll_num']; ?>" disabled<?php endif; ?>  lay-verify="required"
