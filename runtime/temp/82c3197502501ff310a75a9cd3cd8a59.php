<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"D:\pgt\public/../application/admin\view\Music\index.html";i:1599547055;s:46:"D:\pgt\application\admin\view\Public\base.html";i:1599547052;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form class="layui-form" id="form-admin-add" action="">
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <input type="text" name="title" value="" placeholder="请填写歌曲名称" maxlength="12" class="layui-input" onkeyup='clearSymbol(this)'>
                    </div>
                </div>
                <div class="layui-input-inline">
                ...
                <div class="layui-inline" style="float: right;">
                    <span class="layui-btn layui-btn-normal api-add" data-title="新增歌曲"><i class="layui-icon">&#xe608;</i> 新增</span>
                </div>
            </form>
            ...
            return $('#list-admin').DataTable({
                ...
                columnDefs:[
                    ...
                    },
                    {
                        ...
                        "render":function(data, type, row) {
                            var returnStr = '';
                            returnStr += '<div style="display: flex;align-items: center"><span class="layui-btn layui-btn-small edit layui-btn-normal" data-id="' + row.id +'" data-title="编辑" data-url="<?php echo url('edit'); ?>"><i class="layui-icon">&#xe642;</i></span>';
                            ...
                            returnStr += '<audio src="'+row.url+'" style="height: 30px;margin-left:10px " controls></audio></div>';
