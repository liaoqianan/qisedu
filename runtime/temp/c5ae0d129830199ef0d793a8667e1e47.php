<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/www/wwwroot/peigongtang/public/../application/admin/view/Index/index.html";i:1608535063;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-footer" style="text-align: center; line-height: 44px;">
            <strong>Copyright &copy; <?php echo date('Y'); ?> <a href=""><?php echo config('COMPANY_NAME'); ?></a>.</strong> All rights reserved.
        </div>
    </div>
