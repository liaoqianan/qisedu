<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/www/wwwroot/peigongtang/public/../application/admin/view/User/user_course_log.html";i:1609376923;s:64:"/www/wwwroot/peigongtang/application/admin/view/Public/base.html";i:1610075700;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <fieldset class="layui-elem-field">
        ...
        <div class="layui-field-box">
            <form class="layui-form" id="form-admin-add" action="outputExcel">
                ...
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <input type="text" name="course" value="" maxlength="50" placeholder="请填写课程标题" class="layui-input" onkeyup='clearSymbol(this)'>
                    </div>
                </div>

                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <input type="text" name="course_node" value="" maxlength="50" placeholder="请填写课节标题" class="layui-input" onkeyup='clearSymbol(this)'>
                    </div>
                </div>
                <div class="layui-inline">
        ...
        layui.use(['layer', 'form'], function() {
            ...
            var myFun = function (query,start = 0) {
                ...
                return $('#list-admin').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url:'<?php echo url("ajaxgetcourse_log"); ?>' + query,
                        type: 'GET',
