<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/www/wwwroot/peigongtang/public/../application/admin/view/Calendar/index.html";i:1608535059;s:64:"/www/wwwroot/peigongtang/application/admin/view/Public/base.html";i:1610075700;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-field-box">
            ...
            <table class="layui-table" lay-even>
                ...
                <tr>
                    ...
                    <td><?php echo $vo['sun_calibration']; ?></td>
                    <td><?php echo $vo['G_calendar']; ?></td>
                    <td><?php echo $vo['L_calendar']; ?></td>
                    <td><?php echo $vo['S_calendar']; ?></td>
                    <td>
