<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"/www/wwwroot/peigongtang/public/../application/admin/view/Wechat/add.html";i:1611045175;s:65:"/www/wwwroot/peigongtang/application/admin/view/Public/base2.html";i:1608535069;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="text" name="title" maxlength="20" required value="<?php echo !empty($detail['title'])?$detail['title']:''; ?>" lay-verify="required" placeholder="请输入菜单名称" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px; ">
                        <select name="pid">
                            ...
                            <option value="<?php echo $vo['id']; ?>" <?php if(!(empty($detail) || (($detail instanceof \think\Collection || $detail instanceof \think\Paginator ) && $detail->isEmpty()))): if($vo['id'] == $detail['pid']): ?>selected ="selected "<?php endif; endif; ?>><?php if($vo['level'] != 0): ?>|<?php endif; ?><?php echo str_repeat('-', $vo['level']*8)?><?php echo $vo['title']; ?></option>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="text" name="url" value="<?php echo !empty($detail['url'])?$detail['url']:''; ?>"  placeholder="请输入链接" autocomplete="off" class="layui-input">
                    </div>
                </div>*点击可不填
                <div class="layui-form-item">
                    <label class="layui-form-label">菜单类型</label>
                    <div class="layui-input-block">
                        <input type="radio" name="type" value="view" title="链接" <?php if(isset($detail['type'])): if('view' == $detail['type']): ?>checked<?php endif; endif; ?> checked>
                        <input type="radio" name="type" value="miniprogram" title="小程序" <?php if(isset($detail['type'])): if('miniprogram' == $detail['type']): ?>checked<?php endif; endif; ?>>
                        <input type="radio" name="type" value="click" title="点击推送" <?php if(isset($detail['type'])): if('click' == $detail['type']): ?>checked<?php endif; endif; ?>>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">小程序appid</label>
                    <div class="layui-input-inline"  style="width: 500px;">
                        <input type="text" name="appid" value="<?php echo !empty($detail['appid'])?$detail['appid']:''; ?>"  placeholder="请输入小程序appid" autocomplete="off" class="layui-input">
                    </div>
                </div>*当菜单类型为小程序时填写
                <div class="layui-form-item">
                    <label class="layui-form-label">小程序进入页面</label>
                    <div class="layui-input-inline"  style="width: 500px;">
                        <input type="text" name="pagepath" value="<?php echo !empty($detail['pagepath'])?$detail['pagepath']:''; ?>"  placeholder="请输入页面链接；如：pages/index/index" autocomplete="off" class="layui-input">
                    </div>
                </div>*当菜单类型为小程序时填写
                <div class="layui-form-item">
                    <label class="layui-form-label">点击推送关键字</label>
                    <div class="layui-input-inline"  style="width: 500px;">
                        <input type="text" name="key" value="<?php echo !empty($detail['key'])?$detail['key']:''; ?>"  placeholder="点击推送关键字" autocomplete="off" class="layui-input">
                    </div>
                </div>*点击推送
                <div class="layui-form-item">
                    <label class="layui-form-label">排序</label>
                    <div class="layui-input-inline"  style="width: 500px;">
                        <input type="text" name="order" value="<?php echo !empty($detail['order'])?$detail['order']:''; ?>"  placeholder="请输入排序，默认0" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
