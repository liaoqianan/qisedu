<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/wwwroot/peigongtang/public/../application/admin/view/AdminUser/index.html";i:1608535056;s:64:"/www/wwwroot/peigongtang/application/admin/view/Public/base.html";i:1610075700;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <fieldset class="layui-elem-field">
        ...
        <div class="layui-field-box">
            ...
            <table class="layui-table" lay-even>
                ...
                <tr>
                    <th width = '150'>编号</th>
                    <th width="500">用户账号</th>
                    <th width="200">所属角色</th>
                    <th width="500">真实姓名</th>
                    <th width="200">登录次数</th>
                    <th width="350">最后登录时间</th>
                ...
                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                        ...
                        <td>
                            <?php if($vo['status']): ?>
                                <span style="border-radius: 2px;padding:5px 10px;">正常</span>
                                <?php else: ?>
                                <span style="border-radius: 2px;padding:5px 10px;">停用</span>
                            <?php endif; ?>
                        </td>
                        <td>
                            <?php if($vo['status']): ?>
