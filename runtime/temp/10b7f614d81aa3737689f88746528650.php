<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/www/wwwroot/peigongtang/public/../application/admin/view/Question/add.html";i:1617007054;s:65:"/www/wwwroot/peigongtang/application/admin/view/Public/base2.html";i:1608535069;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="type" value="1" title="难度一" <?php if(isset($detail['type'])): if(1
                               == $detail['type']): ?>checked<?php endif; endif; ?> checked>
                        <input type="radio" name="type" value="2" title="难度二" <?php if(isset($detail['type'])): if(2
                               == $detail['type']): ?>checked<?php endif; endif; ?>>
                        <input type="radio" name="type" value="3" title="难度三" <?php if(isset($detail['type'])): if(3
                               == $detail['type']): ?>checked<?php endif; endif; ?>>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"><span style="color:red">*</span> 题型</label>
                    <div class="layui-input-block">
                        <input type="radio" name="q_type" value="1" title="必答题" <?php if(isset($detail['q_type'])): if(1
                               == $detail['q_type']): ?>checked<?php endif; endif; ?> checked>
                        <input type="radio" name="q_type" value="2" title="选答题" <?php if(isset($detail['q_type'])): if(2
                               == $detail['q_type']): ?>checked<?php endif; endif; ?>>
                        <input type="radio" name="q_type" value="3" title="挑战题" <?php if(isset($detail['q_type'])): if(3
                               == $detail['q_type']): ?>checked<?php endif; endif; ?>>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"><span style="color:red">*</span> 题号</label>
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="text" name="number" maxlength="20" required value="<?php echo !empty($detail['number'])?$detail['number']:''; ?>" placeholder="请输入题号" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"><span style="color:red">*</span> 答题时间（秒/s）</label>
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="text" name="second" maxlength="20" required value="<?php echo !empty($detail['second'])?$detail['second']:''; ?>" placeholder="请输入答题时间" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item layui-form-text">
                    <label class="layui-form-label"><span style="color:red">*</span>问答:</label>
                    <div class="layui-input-block" style="width: 600px;">
                        <script style="height: 500px" id="title" name="title" type="text/plain"><?php echo !empty($detail['title'])?$detail['title'] : ''; ?></script>
                        </div>
                        </div>
                        <div class="layui-form-item layui-form-text">
                            <label class="layui-form-label"><span style="color:red">*</span>参考答案:</label>
                        <div class="layui-input-block" style="width: 600px;">
                            <script style="height: 500px" id="right_correct" name="right_correct" type="text/plain"><?php echo !empty($detail['right_correct'])?$detail['right_correct'] : ''; ?></script>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
    ...
    <?php endif; ?>
                        ...
                        <script type="text/javascript">
                            var title = UE.getEditor('title', {
                                toolbars: [
                                    ['source', 'removeformat', '|', 'underline', 'insertunorderedlist', '|','bold', 'italic', 'fontfamily','fontsize', 'lineheight', 'forecolor', 'backcolor', 'simpleupload', 'insertimage', '|', 'justifyleft', 'justifyright', 'justifycenter', 'insertvideo']
                                ],
                                elementPathEnabled : false,wordCount:false,initialFrameWidth:640,initialFrameHeight:500
                            });
                            var right_correct = UE.getEditor('right_correct', {
                                toolbars: [
                                    ['source', 'removeformat', '|', 'underline', 'insertunorderedlist', '|','bold', 'italic', 'fontfamily','fontsize', 'lineheight', 'forecolor', 'backcolor', 'simpleupload', 'insertimage', '|', 'justifyleft', 'justifyright', 'justifycenter', 'insertvideo']
                                ],
                                elementPathEnabled : false,wordCount:false,initialFrameWidth:640,initialFrameHeight:500
