<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/www/wwwroot/peigongtang/public/../application/admin/view/Column/index.html";i:1608535060;s:64:"/www/wwwroot/peigongtang/application/admin/view/Public/base.html";i:1610075700;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-field-box">
            ...
            <table class="layui-table" lay-even>
                ...
                <tr>
                    ...
                    <td>
                        <span data-url="<?php echo url('edit'); ?>" data-id="<?php echo $vo['id']; ?>" data-title="编辑栏目" class="layui-btn layui-btn-small edit layui-btn-normal"><i class="layui-icon">&#xe642;</i></span>
                        <span class="layui-btn layui-btn-small layui-btn-danger confirm" data-id="<?php echo $vo['id']; ?>" data-title="删除栏目" data-info="你确定删除栏目么？" data-url="<?php echo url('del'); ?>"><i class="layui-icon">&#xe640;</i></span>
                    </td>
                </tr>
