<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/www/wwwroot/peigongtang/public/../application/admin/view/Article/add.html";i:1611544827;s:65:"/www/wwwroot/peigongtang/application/admin/view/Public/base2.html";i:1608535069;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 350px">
                        <span class="layui-btn layui-btn-sm layui-btn-normal" id="muisc_file" ><i class="layui-icon">&#xe681;</i>视频</span>
