<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"/www/wwwroot/peigongtang/public/../application/admin/view/Course/add.html";i:1610072958;s:65:"/www/wwwroot/peigongtang/application/admin/view/Public/base2.html";i:1608535069;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="text" name="title" maxlength="20" required value="<?php echo !empty($detail['title'])?$detail['title']:''; ?>" lay-verify="required" placeholder="请输入课程名称" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"><span style="color:red">*</span> 课程封面</label>
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label"><span style="color:red">*</span> 选择栏目</label>
                    <div class="layui-input-inline"  style="width: 500px; ">
                        <select name="column_id">
                            ...
                            <option <?php if(!(empty($detail) || (($detail instanceof \think\Collection || $detail instanceof \think\Paginator ) && $detail->isEmpty()))): if($detail['column_id']==$vo['id']): ?> selected <?php endif; endif; ?> value="<?php echo $vo['id']; ?>"><?php echo $vo['title']; ?></option>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="radio" name="type" value="2" title="点播" <?php if(isset($detail['type'])): if(2 == $detail['type']): ?>checked<?php endif; endif; ?>>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="number" name="original_price" maxlength="20" required value="<?php echo !empty($detail['original_price'])?$detail['original_price']:''; ?>" lay-verify="required" placeholder="请输入原价" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"><span style="color:red">*</span> 现价</label>
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="number" name="present_price" maxlength="20" required value="<?php echo !empty($detail['present_price'])?$detail['present_price']:''; ?>" lay-verify="required" placeholder="请输入现价" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">售后类型</label>
                    <div class="layui-input-block">
                        <input type="radio" name="after_sales" value="1" title="助教" <?php if(isset($detail['after_sales'])): if(1 == $detail['after_sales']): ?>checked<?php endif; endif; ?> checked>
                        <input type="radio" name="after_sales" value="2" title="公众号" <?php if(isset($detail['after_sales'])): if(2 == $detail['after_sales']): ?>checked<?php endif; endif; ?>>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">助教id</label>
                    <div class="layui-input-inline" style="line-height: 36px;">
                        <input type="text" name="assistant" maxlength="100" required value="<?php echo !empty($detail['assistant'])?$detail['assistant']:''; ?>" placeholder="请输入助教id，逗号隔开" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
