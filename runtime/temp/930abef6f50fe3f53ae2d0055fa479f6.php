<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/www/wwwroot/peigongtang/public/../application/admin/view/Teacher/index.html";i:1610009105;s:64:"/www/wwwroot/peigongtang/application/admin/view/Public/base.html";i:1610075700;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form class="layui-form" id="form-admin-add" action="">
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <input type="text" name="name" value="" placeholder="请填写老师或助教名字" maxlength="12" class="layui-input" onkeyup='clearSymbol(this)'>
                    </div>
                </div>
                <div class="layui-input-inline">
                    <select name="type">
            ...
            return $('#list-admin').DataTable({
                ...
                columnDefs:[
                    ...
                    },
                    {
                        ...
                        "targets": 3,
                        "render": function (data, type, row) {
                                return '<img src="'+row.qr_code+'" width="100" height="100"></img> ';
                        }
                    },
                    {
                        "targets":-1,
