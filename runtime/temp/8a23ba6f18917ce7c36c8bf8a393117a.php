<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/www/wwwroot/peigongtang/public/../application/admin/view/Training/add.html";i:1609142215;s:65:"/www/wwwroot/peigongtang/application/admin/view/Public/base2.html";i:1608535069;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <script>
        layui.use('form', function () {
            ...
            form.on('submit(admin-form)', function (data) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo url('training/edit'); ?>",
                    data: data,
